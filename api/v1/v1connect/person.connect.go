...
type PersonServiceClient interface {
	...
	SuggestPerson(context.Context, *connect_go.Request[v1.SuggestPersonRequest]) (*connect_go.Response[v1.SuggestPersonResponse], error)
	...
	SuggestOrganization(context.Context, *connect_go.Request[v1.SuggestOrganizationRequest]) (*connect_go.Response[v1.SuggestOrganizationResponse], error)
...
func (c *personServiceClient) SuggestPerson(ctx context.Context, req *connect_go.Request[v1.SuggestPersonRequest]) (*connect_go.Response[v1.SuggestPersonResponse], error) {
	return c.suggestPerson.CallUnary(ctx, req)
}
...
func (c *personServiceClient) SuggestOrganization(ctx context.Context, req *connect_go.Request[v1.SuggestOrganizationRequest]) (*connect_go.Response[v1.SuggestOrganizationResponse], error) {
	return c.suggestOrganization.CallUnary(ctx, req)
}
...
func NewPersonServiceHandler(svc PersonServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle(PersonServiceSuggestPersonProcedure, connect_go.NewUnaryHandler(
	...
	mux.Handle(PersonServiceSuggestOrganizationProcedure, connect_go.NewUnaryHandler(
...
func (UnimplementedPersonServiceHandler) SuggestPerson(context.Context, *connect_go.Request[v1.SuggestPersonRequest]) (*connect_go.Response[v1.SuggestPersonResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1.PersonService.SuggestPerson is not implemented"))
}
...
func (UnimplementedPersonServiceHandler) SuggestOrganization(context.Context, *connect_go.Request[v1.SuggestOrganizationRequest]) (*connect_go.Response[v1.SuggestOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("api.v1.PersonService.SuggestOrganization is not implemented"))
}
