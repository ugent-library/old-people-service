...
func decodeSetPersonOrcidResponse(resp *http.Response) (res *SetPersonOrcidOK, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &SetPersonOrcidOK{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeSetPersonOrcidTokenResponse(resp *http.Response) (res *SetPersonOrcidTokenOK, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &SetPersonOrcidTokenOK{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeSetPersonRoleResponse(resp *http.Response) (res *SetPersonRoleOK, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &SetPersonRoleOK{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeSetPersonSettingsResponse(resp *http.Response) (res *SetPersonSettingsOK, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &SetPersonSettingsOK{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
