...
func (id *IdentifierDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, IdentifierMutation](ctx, id.sqlExec, id.mutation, id.hooks)
}
...
func (id *IdentifierDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(identifier.Table, sqlgraph.NewFieldSpec(identifier.FieldID, field.TypeInt))
