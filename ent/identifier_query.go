...
func (iq *IdentifierQuery) Order(o ...OrderFunc) *IdentifierQuery {
...
func (iq *IdentifierQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (iq *IdentifierQuery) FirstIDX(ctx context.Context) int {
...
func (iq *IdentifierQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (iq *IdentifierQuery) OnlyIDX(ctx context.Context) int {
...
func (iq *IdentifierQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (iq *IdentifierQuery) IDsX(ctx context.Context) []int {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *IdentifierQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(identifier.Table, identifier.Columns, sqlgraph.NewFieldSpec(identifier.FieldID, field.TypeInt))
	_spec.From = iq.sql
