...
func newIndexSwitcher[T any](client *elasticsearch.Client, alias, settings string, retention int, docFn func(T) (string, []byte, error), config models.BulkIndexerConfig) (*indexSwitcher[T], error) {
