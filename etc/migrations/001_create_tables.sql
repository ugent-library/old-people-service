CREATE TABLE IF NOT EXISTS "organization" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "organization_organization_children" FOREIGN KEY ("parent_id") REFERENCES "organization" ("id") ON UPDATE NO ACTION ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "person" (
  ...
  "role" jsonb NULL, "settings" jsonb NULL,
  "object_class" jsonb NULL,
  "expiration_date" character varying NULL,
  "token" jsonb NULL, PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "organization_person" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "organization_person_organization_organizations" FOREIGN KEY ("organization_id") REFERENCES "organization" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "organization_person_person_people" FOREIGN KEY ("person_id") REFERENCES "person" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
