...
DROP INDEX IF EXISTS organization_identifier_gismo_id_gin;
DROP INDEX IF EXISTS organization_identifier_ugent_id_gin;
DROP INDEX IF EXISTS organization_identifier_biblio_id_gin;
DROP INDEX IF EXISTS organization_identifier_ugent_memorialis_id_gin;
DROP INDEX IF EXISTS person_identifier_ugent_username_gin;
DROP INDEX IF EXISTS person_identifier_ugent_id_gin;
DROP INDEX IF EXISTS person_identifier_historic_ugent_id_gin;
DROP INDEX IF EXISTS person_identifier_old_biblio_id_gin;
