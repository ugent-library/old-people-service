...
type OrganizationService interface {
	...
	GetOrganizationByIdentifier(context.Context, string, ...string) (*Organization, error)
	GetOrganizationsByIdentifier(context.Context, string, ...string) ([]*Organization, error)
